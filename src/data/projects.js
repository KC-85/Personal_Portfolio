export const projects = [
  {
    id: 1,
    title: 'Checkout Girl',
    type: 'Website for a local music artist',
    disciplines: ['Frontend'],
    description: 'A website for a local music artist built with Typescript and Tailwind CSS.',
    categories: ['Typescript', 'Tailwind CSS'],
    tags: ['Typescript', 'Tailwind CSS', 'Music Artist Website'],
    image: null,
    longDescription: 'A modern website for a local music artist that showcases their music, upcoming events, and provides a platform for fans to connect. Built with Typescript for type safety and Tailwind CSS for a responsive design.',
    technologies: ['Typescript', 'Tailwind CSS'],
    features: ['Music player integration', 'Event calendar', 'Responsive design'],
    githubUrl: 'https://github.com/KC-85/Checkout-Girl',
    liveUrl: 'https://checkout-girl.vercel.app/'
  },
  {
    id: 2,
    title: 'MH-Support',
    type: 'Mental Health Support Signposting Platform',
    disciplines: ['Frontend'],
